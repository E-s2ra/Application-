...
-- COMMENTED OUT: Supabase managed projects already have the auth schema and roles configured.
-- Attempting to create or modify them remotely results in permission denied (SQLSTATE 42501).
